...
public class LecteurDonnees {
    ...
    private static DonneesSimulation data = new DonneesSimulation();
    ...
    public static DonneesSimulation createData(String fichierDonnees) {
        data = new DonneesSimulation();
        try {
            lire(fichierDonnees);
    ...
    private void lireCarte() throws DataFormatException {
        ...
        try {
            ...
            NatureTerrain plan[][] = new NatureTerrain[nbLignes][nbColonnes];
            ...
            for (int lig = 0; lig < nbLignes; lig++) {
                for (int col = 0; col < nbColonnes; col++) {
                    lireCase(lig, col, plan);
                }
            }
            data.createCarte(nbLignes, nbColonnes, plan, tailleCases);
     ...
     */
    private void lireCase(int lig, int col, NatureTerrain[][] plan) throws DataFormatException {
        ignorerCommentaires();
        ...
        try {
            ...
            plan[lig][col] = NatureTerrain.valueOf(chaineNature);
    ...
    private void lireIncendies() throws DataFormatException {
        ...
        try {
            ...
            data.createListIncendies(nbIncendies);
    ...
    private void lireIncendie(int i) throws DataFormatException {
        ...
        try {
            ...
            data.addIncendie(lig, col, intensite, i);
            verifieLigneTerminee();
    ...
    private void lireRobots() throws DataFormatException {
        ...
        try {
            ...
            data.createListRobots(nbRobots);
    ...
    private void lireRobot(int i) throws DataFormatException {
        ...
        try {
            ...
            if (s == null) {
                ...
                data.addRobot(lig, col, type, -1, i);
            } else {
                int vitesse = Integer.parseInt(s);
                data.addRobot(lig, col, type, vitesse, i);
                System.out.print(vitesse);
            }
            verifieLigneTerminee();
